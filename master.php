...
while($row=mysql_fetch_array($result))
  {
	...
	$room= $room. "<a href=sellerView.php?id=". $row['random']."> http://negotiatus.com/sellerView.php?id=". $row['random']." </a> <br/><br/>";
  }
...
<div class="header">
    ...
    <?php 
     if(isLoggedIn()) 
          echo '<div id="menu2"><a href="?outszo">logout</a></div>';
    ?>
